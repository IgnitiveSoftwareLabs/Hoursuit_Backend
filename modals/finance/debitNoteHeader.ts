...
interface DebitNoteHeaderAttributes {
    id: number;
...
interface DebitNoteHeaderCreationAttributes
    extends Optional<DebitNoteHeaderAttributes, "id"> { }

class DebitNoteHeader
    extends Model<DebitNoteHeaderAttributes, DebitNoteHeaderCreationAttributes>
    implements DebitNoteHeaderAttributes {
    public id!: number;
    ...
    static validateDebitNoteHeader(m: DebitNoteHeaderAttributes) {
...
DebitNoteHeader.belongsTo(Company, {
    foreignKey: "company_id",
    as: "company",
    onDelete: "CASCADE",
});
DebitNoteHeader.belongsTo(SubsidiaryMaster, {
    foreignKey: "subsidiary_id",
    as: "subsidiary",
    onDelete: "RESTRICT",
});
DebitNoteHeader.belongsTo(VoucherTypeMaster, {
    foreignKey: "voucher_type_id",
    as: "voucherType",
    onDelete: "RESTRICT",
});
DebitNoteHeader.belongsTo(CurrencyMaster, {
    foreignKey: "currency_id",
    as: "currency",
    onDelete: "RESTRICT",
});
DebitNoteHeader.belongsTo(VendorDetails, {
    foreignKey: "vendor_id",
    as: "vendor",
    onDelete: "RESTRICT",
});
DebitNoteHeader.belongsTo(Customer, {
    foreignKey: "customer_id",
    as: "customer",
    onDelete: "RESTRICT",
});
DebitNoteHeader.belongsTo(User, {
...
DebitNoteHeader.belongsTo(JournalEntryHeader, {
    foreignKey: "journal_entry_id",
    as: "journalEntry",
    onDelete: "RESTRICT",
});

Company.hasMany(DebitNoteHeader, {
    foreignKey: "company_id",
    as: "debitNoteHeaders",
    onDelete: "CASCADE",
});
SubsidiaryMaster.hasMany(DebitNoteHeader, {
    foreignKey: "subsidiary_id",
    as: "debitNoteHeaders",
    onDelete: "RESTRICT",
});
VoucherTypeMaster.hasMany(DebitNoteHeader, {
    foreignKey: "voucher_type_id",
    as: "debitNoteHeaders",
    onDelete: "RESTRICT",
});
CurrencyMaster.hasMany(DebitNoteHeader, {
    foreignKey: "currency_id",
    as: "debitNoteHeaders",
    onDelete: "RESTRICT",
});
VendorDetails.hasMany(DebitNoteHeader, {
    foreignKey: "vendor_id",
    as: "debitNoteHeaders",
    onDelete: "RESTRICT",
});
Customer.hasMany(DebitNoteHeader, {
    foreignKey: "customer_id",
    as: "debitNoteHeaders",
    onDelete: "RESTRICT",
});
User.hasMany(DebitNoteHeader, {
    foreignKey: "created_by",
    as: "createdDebitNotes",
    onDelete: "RESTRICT",
});
User.hasMany(DebitNoteHeader, {
    foreignKey: "updated_by",
    as: "updatedDebitNotes",
    onDelete: "RESTRICT",
});
JournalEntryHeader.hasMany(DebitNoteHeader, {
    foreignKey: "journal_entry_id",
    as: "debitNotes",
    onDelete: "RESTRICT",
});

export default DebitNoteHeader;
